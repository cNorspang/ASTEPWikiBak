...
### Combination of Weights
  In this section the combination of weights done by the combiner will be explained, for more information check [WeightCombiner](https://daisy-git.cs.aau.dk/astep-2021/astep-6/-/wikis/home).
