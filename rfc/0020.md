...
### Combination of Weights
  Work in progess
  In this section the combination of weights done by the combiner will be explained, the data within the models will be combined to one model. For more information check the wiki and implementation of a combiner LINK.
