...
The TNM should also be easily modified, as long as it only changes the `data` attribute. However, everything is subject to change, but the `data` attribute has been designed with rapid changing as part of its design.
