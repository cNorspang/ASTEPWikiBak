...
An example of a conversionScheme function is shown below in the [data_model.py](#data_model.py)
  ...
  def SwEdgeConversionScheme(row):
      ...
      return edge
  ```
When a microservice introduces new data into the TNM, this file needs to be updated to accomodate the new data. ´data_model.py´ is used 
### The data Attribute
