...
- `weight` is a measure from 0 (good) to 1 (bad) as to how well the road is to travel. A more detailed description is found in the [Weight Combiner](/services/TNM_Combiner_WeightCombiner).
