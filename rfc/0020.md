...
### Combination of Weights
  ...
  #### Expected input
  The expected input for combination of weights is multiple TNMs as shown in [The format](#the-format) in a list (in JSON).
  #### Output
  A single TNM.
  #### Process
  ...
  If these does not hold, then the microservice give errors or combine the models incorrecly.
