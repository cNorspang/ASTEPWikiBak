...
### Combination of Weights
  ...
  #### Expected input
  The expected input for combination of weights is multiple TNMs as shown in [The format](#the-format) in a list (in JSON of course).
  #### Output
  A single TNM.
  #### Process
  Insert math here
