...
## Output
The router will return a **TNM** containing the route within a json string. Only the edges with fuel stations that should be used, will have the attribute _fuel_Station_ set to true, the others will be set to false, to enabling telling the user what fuel station to take.
